...
dnl PHP_ARG_WITH([hello],
dnl   [for hello support],
dnl   [AS_HELP_STRING([--with-hello],
dnl     [Include hello support])])
...
if test "$PHP_HELLO" != "no"; then
  ...
  dnl PHP_EVAL_LIBLINE($LIBFOO_LIBS, HELLO_SHARED_LIBADD)
  ...
  dnl [
  dnl   AC_DEFINE(HAVE_HELLO_FEATURE, 1, [ ])
  dnl ],[
  dnl   AC_MSG_ERROR([FEATURE not supported by your hello library.])
  dnl ], [
  dnl   $LIBFOO_LIBS
  dnl ])
